<%@ Page Title="" Language="C#" MasterPageFile="~/zichanchu/MasterPage.master" AutoEventWireup="true" CodeFile="NewsManagement.aspx.cs" Inherits="admin_NewsManagement" %>
        ...
        <asp:GridView ID="GridView1" ShowFooter="false" BorderColor="Black" OnRowDataBound="GridView1_RowDataBound"  runat="server" AutoGenerateColumns="False"  Font-Size="12px" Width="100%"  AllowPaging="True" OnRowDeleting="GridView1_RowDeleting">
          <Columns>
            ...
            <asp:TemplateField HeaderText="信息内容">
                    <ItemTemplate>
                        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "XinxiDetails.aspx?ID="+Eval("ID")%>'
                            Text='<%# "信息详情" %>'></asp:HyperLink>
                    </ItemTemplate>
            </asp:TemplateField>
