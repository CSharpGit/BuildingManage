<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers356.aspx.cs" Inherits="Default6" %>
    ...
    <tr>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        <asp:TreeNode Value="Parent1" Expanded="True" Text="管理员查询">
                                            ...
                                            <asp:TreeNode Value="Child1H" Text="房间用途查询" Expanded="True">
                                                <asp:TreeNode Value="Child1I" Text="教学用房" NavigateUrl="~/Inquiers355.aspx" />
                                                <asp:TreeNode Value="Child1J" Text="行政用房" NavigateUrl="~/Inquiers356.aspx" Selected="True" />
        ...
        <td style="height:auto;width:690px;" valign="top">
            ...
            <div style="height:auto;width:690px;">
                <div style="height:40px; width:690px; margin-bottom: 0;text-align:center;vertical-align:center;">
                    提示:单击按钮可将表格数据导出保存
                    &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div style="height:700px; width:690px; overflow: scroll">
                    <asp:GridView ID="GridView1" runat="server" Width="690px" CellPadding="4" 
