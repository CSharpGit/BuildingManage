<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers52.aspx.cs" Inherits="Default2" EnableEventValidation="false"%>
    ...
    <tr>
                            ...
                            <asp:TreeView ID="TreeView2" runat="server" ImageSet="XPFileExplorer" NodeIndent="15"
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        <asp:TreeNode Value="Parent1" Expanded="True" Text="管理员查询">
                                        ...
                                        <asp:TreeNode Value="Parent2" Expanded="false" Text="各院系查询" Checked="True">
                                            ...
                                            <asp:TreeNode Value="Child2L" Text="外国语学院" NavigateUrl="~/Inquiers311.aspx"></asp:TreeNode>
        ...
        <td class="style16">
            ...
            <div style="width:690px;height:auto;">
                <div style="width:690px; height:50px; text-align:center;">                  
                    <asp:DropDownList ID="DropDownList1" runat="server" Height="20" Width="200"
                        DataSourceID="SqlDataSourcebyxueyuan" DataTextField="department" 
                        DataValueField="department">
                    </asp:DropDownList>
                    <asp:DropDownList ID="DropDownList2" runat="server"  Height="20" Width="140">
                        <asp:ListItem Value="0">教学用房</asp:ListItem>
                        <asp:ListItem Value="1">行政用房</asp:ListItem>
                        <asp:ListItem Value="2">实验用房</asp:ListItem>
                        <asp:ListItem Value="3">教研室</asp:ListItem>
                        <asp:ListItem Value="4">研究室</asp:ListItem>
                        <asp:ListItem Value="5">卫生间</asp:ListItem>
                        <asp:ListItem Value="6">库房</asp:ListItem>
                        <asp:ListItem Value="7">配电室</asp:ListItem>
                        <asp:ListItem Value="8">其它用房</asp:ListItem>
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" Text="查询" onclick="Button1_Click" Width="60px" Height="25px" style="margin-bottom: 0"  />
                    &nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" Text="导出" Width="60px" Height="25px" onclick="Button2_Click"/>
                    <br /><br />
                    <asp:SqlDataSource ID="SqlDataSourcebyxueyuan" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:BuildingManageConnectionString2 %>" 
                        SelectCommand="SELECT DISTINCT [department] FROM [Fangjian]"></asp:SqlDataSource>                    
                </div>
                <div style="width:690px;height:700px; overflow:scroll;">
