<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers306.aspx.cs" Inherits="Default6" %>
    ...
    <tr>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent2" Expanded="True" Text="各院系查询">
                                            ...
                                            <asp:TreeNode Value="Child2G" Text="体育学院" NavigateUrl="~/Inquiers306.aspx" 
        ...
        <td style="height:auto;width:690px;" valign="top">
            ...
            <div style="height:auto;width:690px;">
                <div style="height:100px; width:690px; margin-bottom: 0;text-align:center;vertical-align:center;">
                  请输入所要选择的学院&nbsp
                    <asp:DropDownList ID="DropDownList1" runat="server"  Width="140px" 
                        Height="25px">
                        <asp:ListItem Value="0">体育学院</asp:ListItem>
                        ...
                        <asp:ListItem Value="5">电气工程学院</asp:ListItem>
                ...
                <br />
                <br />
                 <div style="height:500px; width:690px; overflow: scroll">
