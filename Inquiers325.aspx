<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers325.aspx.cs" Inherits="Default6" %>
                                    ...
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent3" Expanded="True" Text="其他部门查询">
                                            ...
                                            <asp:TreeNode Value="Child3G" Text="工程训练教学中心" 
                                                NavigateUrl="~/Inquiers325.aspx" Selected="True" />
