<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers302.aspx.cs" Inherits="Default6" %>
...
<table height="700">
    ...
    <tr>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent2" Expanded="True" Text="各院系查询">
                                            ...
                                            <asp:TreeNode Value="Child2B" Text="自动化工程学院" NavigateUrl="~/Inquiers302.aspx" 
        ...
        <td style="height:auto;width:690px;" valign="top">
            ...
            <div style="height:auot;width:690px;">
                <div style="height:100px; width:690px; margin-bottom: 0;text-align:center;vertical-align:center;">
                  请输入所要选择的学院&nbsp
                    <asp:DropDownList ID="DropDownList1" runat="server"  Width="140px" 
                        Height="25px">
                        <asp:ListItem Value="0">自动化工程学院</asp:ListItem>
                        <asp:ListItem Value="1">电气工程学院</asp:ListItem>
