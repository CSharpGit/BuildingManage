<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers51.aspx.cs" Inherits="Default2" %>
...
<table>
    ...
    <tr>
        <td class="style15" valign="top" style="padding-top:55px;">
        ...
        <td class="style16">
            ...
            <div style="width:690px;height:auto;">
                ...
                <div style="width:690px;height:auto;">   
                    <div style="width:160px; height:40px; position:absolute; z-index:11;  margin-left:125px; margin-top:30px;">
                        <asp:Button ID="Button3" runat="server" onclick="Button1_Click" 
                        Text="查询" Width="60px" Height="25px"/>
                        &nbsp;&nbsp;
                        <asp:Button ID="Button4" runat="server" onclick="Button2_Click" 
                        Text="导出" Width="60px" Height="25px"/>
                    </div>                 
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" 
                                DataSourceID="SqlDataSource511" DataTextField="campus" DataValueField="campus">
                            </asp:DropDownList>
                            &nbsp;
                            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" 
                                DataSourceID="SqlDataSource512" DataTextField="building" DataValueField="B_id">
                            </asp:DropDownList>
                            &nbsp;
                            <asp:DropDownList ID="DropDownList3" runat="server" AutoPostBack="True" 
                                DataSourceID="SqlDataSource513" DataTextField="Cname">
                            </asp:DropDownList>
                            &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:SqlDataSource ID="SqlDataSource511" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:BuildingManageConnectionString2 %>" 
                                SelectCommand="SELECT DISTINCT [campus] FROM [Louyu]"></asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSource512" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:BuildingManageConnectionString2 %>" 
                                SelectCommand="SELECT DISTINCT [campus], [building], [B_id] FROM [Louyu] WHERE ([campus] = @campus)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DropDownList1" Name="campus" 
                                        PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <asp:SqlDataSource ID="SqlDataSource513" runat="server" 
                                ConnectionString="<%$ ConnectionStrings:BuildingManageConnectionString2 %>" 
                                SelectCommand="SELECT DISTINCT [B_id], [Cname] FROM [Fangjian] WHERE ([B_id] = @B_id)">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="DropDownList2" Name="B_id" 
                                        PropertyName="SelectedValue" Type="Int32" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                            <div style="overflow:auto;height:500px; width:690px;">
                            <br /><br /><br />
                            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                                    Width="690px" style="margin-top: 0">
