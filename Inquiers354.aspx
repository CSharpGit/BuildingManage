<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers354.aspx.cs" Inherits="Default6" %>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        <asp:TreeNode Value="Parent1" Expanded="True" Text="管理员查询">
                                            ...
                                            <asp:TreeNode Value="Child1C" Text="独立部门查询" Expanded="True">
