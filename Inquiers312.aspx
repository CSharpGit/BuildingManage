<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers312.aspx.cs" Inherits="Default6" %>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent2" Expanded="True" Text="各院系查询">
                                            ...
                                            <asp:TreeNode Value="Child2M" Text="社会科学学院" NavigateUrl="~/Inquiers312.aspx" 
                ...
                <div style="height:100px; width:690px; margin-bottom: 0;text-align:center;vertical-align:center;">
                  请输入所要选择的学院&nbsp
                    <asp:DropDownList ID="DropDownList1" runat="server"  Width="140px" 
                        Height="25px">
                        <asp:ListItem Value="0">社会科学学院</asp:ListItem>
                        ...
                        <asp:ListItem Value="11">电气工程学院</asp:ListItem>
