<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers301.aspx.cs" Inherits="Default6" %>
...
<table height="700">
    ...
    <tr>
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent2" Expanded="True" Text="各院系查询">
                                            <asp:TreeNode Value="Child2A" Text="电气工程学院" NavigateUrl="~/Inquiers301.aspx" 
        ...
        <td style="height:auto;width:750px;" valign="top">
                ...
                <div style="height:100px; width:690px; margin-bottom: 0;text-align:center;vertical-align:center;">
                  请输入所要选择的学院&nbsp
                    <asp:DropDownList ID="DropDownList1" runat="server"  Width="140px" 
                        Height="25px">
                        <asp:ListItem Value="0">电气工程学院</asp:ListItem>
                        ...
                        <asp:ListItem Value="10">外国语学院</asp:ListItem>
                    ...
                    &nbsp;&nbsp;
                    <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="确定"  Width="60px" Height="25px"/>
                    &nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" Text="导出" Width="60px" Height="25px" 
