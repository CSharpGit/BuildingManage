<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Inquiers340.aspx.cs" Inherits="Default6" %>
                            ...
                            <asp:TreeView ID="TreeView2" runat="server" ImageSet="XPFileExplorer" NodeIndent="15"
                                ...
                                <Nodes>
                                    <asp:TreeNode Value="genjiedian" Expanded="True" Text="综合查询">
                                        ...
                                        <asp:TreeNode Value="Parent3" Expanded="True" Text="其他部门查询">
                                            ...
                                            <asp:TreeNode Value="Child3T" Text="后勤保障部" NavigateUrl="~/Inquiers340.aspx" Selected="True" />
