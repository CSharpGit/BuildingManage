...
using English.bll;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (s1 == "电气工程学院" || Convert.ToInt32(Session["root"].ToString()) == 20)
            {
                ...
                using (SqlConnection conn = new SqlConnection(connectionStr))
                {
                    ...
                    {
                        Response.Write("<Script Language=JavaScript>if(confirm('数据为空,请重新查询！')){window.navigate('Inquiers301.aspx');} </Script>");
                    }
            ...
            {
                RegisterStartupScript("", "<script>alert('对不起，您没有权限查看这一类信息');window.location='Inquiers301.aspx'</script>");
            }
